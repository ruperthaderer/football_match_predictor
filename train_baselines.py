# 12) train_baselines.py
# Baselines für 3-Klassen (H/D/A) auf features_lagged.csv
...
# --- Offensichtliche Duplikate + Leakage-Spalten droppen ---
drop_always = [
...
# errors='ignore' falls Spalten nicht vorhanden sind
